...
# =============================================================================
# k3s Worker (Agent) Node Installation
# =============================================================================
# Usage: bash install-worker.sh
# Required env vars:
#   MASTER_IP       – public IP of the master VPS
#   K3S_NODE_TOKEN  – token from master (/var/lib/rancher/k3s/server/node-token)
# Optional:
#   K3S_VERSION     – must match master version, e.g. v1.32.2+k3s1
# =============================================================================

echo "🚀 Installing k3s — Worker Node"

# --- Variables ---
MASTER_IP="${MASTER_IP:?'Error: export MASTER_IP=<master-public-ip>'}"
K3S_NODE_TOKEN="${K3S_NODE_TOKEN:?'Error: export K3S_NODE_TOKEN=<token-from-master>'}"
